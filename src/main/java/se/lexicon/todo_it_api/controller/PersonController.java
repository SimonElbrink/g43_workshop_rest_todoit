...
public class PersonController {
    ...
    @PostMapping
    public ResponseEntity<PersonDto> create(@RequestBody @Valid PersonForm creationForm) {
    ...
    @PutMapping(path = "/{id}")
    public ResponseEntity<PersonDto> update(@PathVariable("id") Integer personId, @RequestBody @Valid PersonForm updateForm) {
